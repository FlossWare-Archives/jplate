...
/**
 *
 * This exception is raised when a directive cache is invalid...
 *
 */
public class InvalidDirectiveCacheException extends TemplateException
{
    /**
     *
     * Default constructor.
     *
     */
    public InvalidDirectiveCacheException ()
    {
    }
     ...
     *
     */
    public InvalidDirectiveCacheException ( final String msg )
    {
        super ( msg );
    }
     ...
     *
     */
    public InvalidDirectiveCacheException ( final Throwable rootCause )
    {
        super ( rootCause );
    }
