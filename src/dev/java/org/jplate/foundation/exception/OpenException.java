...
Modifications:
    ...
    $Revision: 479 $
    $HeadURL: https://jplate.svn.sourceforge.net/svnroot/jplate/trunk/src/dev/java/org/jplate/foundation/exception/OpenException.java $
    </pre>

*/
public class OpenException extends FoundationException
{
    // ----------------------------------------------------------------------
    //
     ...
     *
     */
    public OpenException ( final String msg )
    {
        super ( msg );
    }
     ...
     *
     */
    public OpenException ( final Throwable rootCause )
    {
        super ( rootCause );
    }
     ...
     *
     */
    public OpenException ( final String msg, final Throwable rootCause )
    {
        super ( msg, rootCause );
    }
