...
Modifications:
    ...
    $Revision: 479 $
    $HeadURL: https://jplate.svn.sourceforge.net/svnroot/jplate/trunk/src/dev/java/org/jplate/foundation/exception/CreateException.java $
    </pre>

*/
public class CreateException extends FoundationException
{
    // ----------------------------------------------------------------------
    //
     ...
     *
     */
    public CreateException ( final Throwable rootCause )
    {
        super ( rootCause );
    }
     ...
     *
     */
    public CreateException ( final String msg, final Throwable rootCause )
    {
        super ( msg, rootCause );
    }
