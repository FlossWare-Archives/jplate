...
Modifications:
    ...
    $Revision: 479 $
    $HeadURL: https://jplate.svn.sourceforge.net/svnroot/jplate/trunk/src/dev/java/org/jplate/foundation/exception/AddException.java $
    </pre>

*/
public class AddException extends FoundationException
{
    // ----------------------------------------------------------------------
    //
     ...
     *
     */
    public AddException ( final String msg )
    {
        super ( msg );
    }
     ...
     *
     */
    public AddException ( final Throwable rootCause )
    {
        super ( rootCause );
    }
     ...
     *
     */
    public AddException ( final String msg, final Throwable rootCause )
    {
        super ( msg, rootCause );
    }
