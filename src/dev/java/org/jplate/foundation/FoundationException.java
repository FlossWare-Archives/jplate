...
Modifications:
    ...
    $Revision: 479 $
    $Author: sfloess $
    $HeadURL: https://jplate.svn.sourceforge.net/svnroot/jplate/trunk/src/dev/java/org/jplate/foundation/FoundationException.java $
    </pre>

*/
public class FoundationException extends JPlateException
{
    // ----------------------------------------------------------------------
    //
     ...
     *
     */
    public FoundationException ( final String msg )
    {
        super ( msg );
    }
     ...
     *
     */
    public FoundationException ( final Throwable rootCause )
    {
        super ( rootCause );
    }
     ...
     *
     */
    public FoundationException ( final String msg, final Throwable rootCause )
    {
        super ( msg, rootCause );
    }
