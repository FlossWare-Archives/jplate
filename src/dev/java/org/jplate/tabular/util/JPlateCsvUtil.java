...
import org.jplate.tabular.csv.parser.impl.defaults.DefaultJPlateCsvParser;
...
Modifications:
    ...
    $Revision: 479 $
    $Author: sfloess $
    $HeadURL: https://jplate.svn.sourceforge.net/svnroot/jplate/trunk/src/dev/java/org/jplate/tabular/util/JPlateCsvUtil.java $
    </pre>

*/
public class JPlateCsvUtil
{
    // ----------------------------------------------------------------------
    //
    ...
    /**
     *
     * Create a {@link List} of JPlate CSV parsed data contained in
     * <code>inputStream</code>.
     *
     * @param inputStream A stream JPlate CSV data.
     *
            ...
            throws TabularException
    {
        try
        {
            final DefaultJPlateCsvParser <DefaultTabularListBuilder> csvParser  =
                new DefaultJPlateCsvParser <DefaultTabularListBuilder> ();
    ...
    /**
     *
     * Create a {@link TableIfc} of JPlate CSV parsed data contained in
     * <code>inputStream</code>.
     *
     * @param inputStream A stream JPlate CSV data.
     *
        ...
        throws TabularException
    {
        try
        {
            final DefaultJPlateCsvParser <DefaultTableBuilder> csvParser  =
                new DefaultJPlateCsvParser <DefaultTableBuilder> ();
