...
Modifications:
    ...
    $Revision: 479 $
    $HeadURL: https://jplate.svn.sourceforge.net/svnroot/jplate/trunk/src/dev/java/org/jplate/kvp/KvpException.java $
    </pre>

*/
public class KvpException extends JPlateException
{
    // ----------------------------------------------------------------------
    //
     ...
     *
     */
    public KvpException ( final String msg )
    {
        super ( msg );
    }
     ...
     *
     */
    public KvpException ( final Throwable rootCause )
    {
        super ( rootCause );
    }
     ...
     *
     */
    public KvpException ( final String msg, final Throwable rootCause )
    {
        super ( msg, rootCause );
    }
